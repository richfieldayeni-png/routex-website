...
import { ClipboardList, Shield, Ban, RefreshCw, ShieldAlert, ArrowRight } from 'lucide-react'
...
const policies = [
  { title: 'Terms of Use', desc: 'The rules and conditions that govern your use of the RouteX platform, app, and services.', href: '/terms', icon: ClipboardList },
  { title: 'Privacy Policy', desc: 'How we collect, use, store, and protect your personal data in compliance with the NDPA 2023.', href: '/privacy', icon: Shield },
  { title: 'Trip Cancellation Policy', desc: 'When and how trips can be cancelled, who can cancel, and what happens when a cancellation occurs.', href: '/policies/trip-cancellation', icon: Ban },
  { title: 'Refund Policy', desc: 'How refunds are processed, eligibility criteria, timelines, and how to request a refund.', href: '/policies/refund', icon: RefreshCw },
  { title: 'Behaviour Policy', desc: 'The standards of conduct expected from all passengers and drivers on the RouteX platform.', href: '/policies/behaviour', icon: ShieldAlert },
]
    ...
    <>
      ...
      <div style={{ maxWidth: '860px', margin: '0 auto', padding: '64px 24px 96px' }}>
          ...
          {policies.map((policy) => {
            ...
            return (
              ...
              >
                ...
                <ArrowRight className="w-5 h-5 text-[#1A5632] flex-shrink-0" />
              </Link>
            )
          })}
        </div>
        ...
        <div style={{ background: 'var(--green-lt)', border: '1px solid var(--green-md)', borderRadius: '12px', padding: '28px 32px' }}>
          <h3 style={{ fontFamily: 'var(--display)', fontSize: '18px', fontWeight: 700, color: 'var(--black)', marginBottom: '10px' }}>
